<?php
 ...
 if ($_POST['submit']){
	...
	if (another_email_exist($email, $memberID, $db)){
	...
	<form action="profile.php" method="POST">
		...
		<table>
			<tr>
				<td>First Name</td>
				<td><input type="text" name="firstName" value="<?php if ($_GET['error'] == 1) { echo $_GET['s_firstName']; } else { echo $fName; } ?>"></td>
			</tr>
			<tr>
				<td>Last Name</td>
				<td><input type="text" name="lastName" value="<?php if ($_GET['error'] == 1) { echo $_GET['s_lastName']; } else { echo $lName; } ?>"></td>
			</tr>
			<tr>
				<td>Email</td>
				<td><input type="text" name="email" value="<?php if ($_GET['error'] == 1) { echo $_GET['s_email']; } else { echo $email; } ?>"></td>
			</tr>
			<tr>
				<td>Intro</td>
				<td>
